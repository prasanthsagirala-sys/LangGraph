...
os.environ["LANGSMITH_PROJECT"] = "RAG Chatbot Final Version"

PDF_PATH = r"C:\Users\sgp\Desktop\GenAI\LangGraph\08 Chatbot with RAG as Tool\The Compound Effect - Darren hardy ( PDFDrive ).pdf"  # change to your file
INDEX_ROOT = Path(os.path.join(os.path.dirname(__file__), '.indices'))
...
def _index_key(pdf_path: str, chunk_size: int, chunk_overlap: int, embed_model_name: str) -> str:
    ...
    #Below hash changes if any of the meta values change. This hash is used to create unique index directory
...
def load_or_build_index(
    ...
    index_dir = INDEX_ROOT / key # directory for this index
